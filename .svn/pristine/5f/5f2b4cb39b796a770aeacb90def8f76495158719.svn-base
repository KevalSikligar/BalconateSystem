<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="ViewPage<RSVPModel>" %>
...
<div class="main">
    ...
    <div class="form">
            ...
            <div style="margin-top: 5px;">
                    <div>Tell us how many people in your party:</div>
                    <%:Html.TextAreaFor(m => m.Notes, new { @class="k-textbox clear", style="width: 300px; height: 70px;" }) %>
            </div>
            
            <div style="margin-top: 10px;">
                    <input class="k-button bold" type="submit" value="RSVP" onClick="ga('send', 'event', { eventCategory: 'rsvp', eventAction: 'send'});" />
            </div>
