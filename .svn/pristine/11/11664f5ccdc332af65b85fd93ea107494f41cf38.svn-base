...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
	<div class="main">		
		...
		<div id="two-icons">
			<h3 id="online-quote"><a href="<%=Url.Action("what-we-offer") %>">What we offer and how to get a quote &raquo;</a></h3>
			<h3 id="why-choose-our-decking"><a href="<%=Url.Action("why-choose-our-decking") %>">Why choose our decking?</a></h3>
		</div>
		...
		<div class="left topicons">
			<div class="icons">
				...
				<h3><a href="<%=Url.Action("textures-and-finishes") %>" id="decking-board-finishes" class="double-line">Decking Board<br />Finishes</a></h3>
				<h3><a href="<%=Url.Action("composite-decking-accessories") %>" id="accessories">Accessories</a></h3>
				<h3><a href="<%=Url.Action("applications") %>" id="applications" class="last">Applications</a></h3>
		...
		<ul id="cookie-menu">
			<li><a href="/">HOME</a></li>
			<li class="last">DECKING</li>
		</ul>
		<div class="left">	
			<div class="left-content cmsblock" id="f_body" contenteditable="<%:this.IsAdmin().ToString().ToLower() %>">
			    <%=Model.HomepageBody %>
			</div>
		</div>
		<div class="right">
