...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" runat="server">
	<div class="main">		
		...
		<div id="two-icons">
			...
			<h3 id="why-choose-us"><a href="<%:Url.Action("why-choose-us-for-glass-balustrades") %>">Why<br />choose<br />us?</a></h3>
		</div>
		...
		<div class="left topicons">
			<div class="icons">
				<h3><a href="<%:Url.Action("options-available") %>" id="types-of-balustrade-systems" class="double-line">Types of Balustrade Systems</a></h3>
				<h3><a href="<%:Url.Action("technical-details") %>" id="technical-details">Technical details</a></h3>
				<h3><a href="<%:Url.Action("how-to-install-glass-balustrades") %>" id="how-to-install-glass-balustrade" class="double-line">How to install<br />glass Balustrade</a></h3>
				<h3><a href="<%:Url.Action("trade-customers") %>" id="trade-customers" class="last">Trade Customers</a></h3>
			<div class="slider-wrapper theme-sidebar">
				<div class="ribbon"></div>
                <div id="slider-sidebar" class="nivoSlider">					
                    <% foreach (var image in Model.SmallImages) { %>
				    <a href="<%:Url.Action("photos") %>" title="<%=image.Description %>">
                        <img src="<%=image.ThumbUrl %>" alt="<%=image.Name %>" />
				    </a>
                    <% } %>
				</div>
		...
		<ul id="cookie-menu">
            ...
            <li class="last"><%:ViewBag.AreaName %></li>
		    <% } %>
		</ul>
		<div class="left">
		...
		<div class="right">
			...
			<div id="f_links" class="links" contenteditable="<%:this.IsAdmin() %>" style="<%=(Model.Links == null ? "display: none;" : "")%>">
